...
site_dir="${root}/site"
hex_source="${1:-${root}/build/stable/all-mens-morris.ino.hex}"
...
cp "${hex_source}" "${site_dir}/build/all-mens-morris-latest.hex"
...
Ardens web player files are fetched during the All Men's Morris Pages build.
