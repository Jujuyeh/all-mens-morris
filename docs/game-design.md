...
- Main menu scaffold for choosing board/ruleset pairings, with Classic Nine
  Men's Morris, Diamond, Hourglass, Clover, Fortress, Hexagon, Six Men's Morris,
  Three Men's Morris, and Flower active as boards.
...
- Playable Diamond, Hourglass, Clover, and Fortress board profiles for alternate
  graph shapes that still fit the 64x64 playfield.
