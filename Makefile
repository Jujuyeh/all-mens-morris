...
AVR_SIZE ?= avr-size
AVR_NM ?= avr-nm
ARDUINO_SIZE_FLAGS := --build-property compiler.c.extra_flags="-mcall-prologues" --build-property compiler.cpp.extra_flags="-mcall-prologues" --build-property compiler.c.elf.extra_flags="-Wl,--relax"

ifeq ($(BUILD),debug)
ARDUINO_BUILD_FLAGS := --build-property compiler.cpp.extra_flags="-DALL_MENS_MORRIS_DEBUG=1 -mcall-prologues" --build-property compiler.c.extra_flags="-mcall-prologues" --build-property compiler.c.elf.extra_flags="-Wl,--relax"
else ifeq ($(BUILD),fxc)
ARDUINO_BUILD_FLAGS := --build-property compiler.cpp.extra_flags="-DALL_MENS_MORRIS_FXC_LINK=1 -mcall-prologues" --build-property compiler.c.extra_flags="-mcall-prologues" --build-property compiler.c.elf.extra_flags="-Wl,--relax"
